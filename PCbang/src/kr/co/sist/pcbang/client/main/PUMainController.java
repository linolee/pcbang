...
//			System.exit(0);
		 ...
		 * System.out.println(flag);//0,1,2순으로 나온다. switch (flag) { // case 0 ,1 ,2 로도
		 * 줄수 있지만 무엇인지 명확하지 않기때문에 상수표현을 쓴다. case JOptionPane.OK_OPTION :
		 * JOptionPane.showMessageDialog(this, "!"); break; case JOptionPane.NO_OPTION:
		 * String menu = JOptionPane.showInputDialog("어떤 점심 메뉴였어요?");
		 * JOptionPane.showMessageDialog(this,menu+"가 다 그렇죠 뭐!"); break; case
		 * JOptionPane.CANCEL_OPTION: JOptionPane.showMessageDialog(this, "하기 싫으냐??");
		 * }//end switch
		 */
	}// callcharge
