...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public void updateStat() {
		try {
			// 해당 좌석에 남은 주문목록이 남아있는지 확인하고
			if(pmo_dao.chkOrder(seatNum)) {
				// order_status를 N로 변경한다
				pmo_dao.updateOrderStat(seatNum);
//				if(pmo_dao.updateOrderStat(seatNum)){
//					JOptionPane.showMessageDialog(pmov, "orderStat test");
//				}
			}
		} catch (SQLException e) {
			e.printStackTrace();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public void mouseClicked(MouseEvent me) {
		if(me.getSource() == pmov.getJtOrder()) {//주문테이블이 눌렸는지 ? 
			...
			//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			seatNum=(int) (jt.getValueAt(jt.getSelectedRow(), 2));
			//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
